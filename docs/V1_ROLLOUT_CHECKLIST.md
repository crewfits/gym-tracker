...
- [ ] Confirm no automated WhatsApp env vars, cron routes, reminder delivery tables, or member opt-in fields are present; owner-triggered reminders remain available.
