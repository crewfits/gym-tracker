...
const rolePermissions: Record<GymRole, ReadonlySet<Permission>> = {
  owner: new Set([
    ...
    "plans.manage", "reminders.manage", "settings.manage", "staff.manage",
  ]),
  ...
  trainer: new Set([
    ...
    "payments.manage", "payments.view", "receipts.view", "plans.manage", "reminders.manage",
  ]),
  admin: new Set([
    "attendance.scan", "attendance.view", "exports.attendance", "exports.members", "exports.payments",
    "members.create", "members.manage", "members.view", "payments.manage", "payments.view", "receipts.view",
    "plans.manage", "reminders.manage", "settings.manage", "staff.manage", "feature_flags.manage",
  ]),
};
