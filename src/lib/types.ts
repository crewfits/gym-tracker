...
export interface MemberQrCredential { member_id: string; gym_id: string; version: number; enabled: boolean; issued_at: string; rotated_at: string | null; changed_by: string | null; updated_at: string }
