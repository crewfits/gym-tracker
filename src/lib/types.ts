...
export interface AttendanceEvent { id: string; gym_id: string; member_id: string; membership_id: string | null; direction: AttendanceDirection; qr_version: number | null; source: "qr" | "manual"; scanned_by: string | null; request_id: string; occurred_at: string; created_at: string }
