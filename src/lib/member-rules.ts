...
export function duplicatePhoneOutcome(duplicate: PhoneDuplicate | null, sharedPhoneConfirmed: boolean): DuplicatePhoneOutcome {
  if (!duplicate || sharedPhoneConfirmed) return "allow";
