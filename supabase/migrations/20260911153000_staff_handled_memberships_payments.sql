alter table public.memberships
  add column if not exists handled_by_gym_user_id uuid,
  drop constraint if exists memberships_handled_by_gym_user_fk,
...
alter table public.payments
  add column if not exists handled_by_gym_user_id uuid,
  drop constraint if exists payments_handled_by_gym_user_fk,
...
create index if not exists memberships_handled_by_idx on public.memberships(gym_id, handled_by_gym_user_id) where handled_by_gym_user_id is not null;
create index if not exists payments_handled_by_idx on public.payments(gym_id, handled_by_gym_user_id) where handled_by_gym_user_id is not null;
